import "./ui/friend_profile.css";
import "./ui/friend_header.css";
import { HeaderWidget } from "@/widgets/header";
import { SidebarWidget } from "@/widgets/sidebar";
import { mountFriendProfile } from "./ui/controller";
import html from "./ui/friend_profile.html?raw";

export function renderFriendProfilePage() {
	...
	const root = app?.querySelector("#friend-profile-body") as HTMLElement;
