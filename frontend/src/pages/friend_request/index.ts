import "./ui/friend_request.css";
import "./ui/friend_header.css";
import { HeaderWidget } from "@/widgets/header";
import { SidebarWidget } from "@/widgets/sidebar";
import { mountFriendRequest } from "./ui/controller";
import html from "./ui/friend_request.html?raw";
...
export function renderFriendRequestPage() {
	...
	const root = app?.querySelector("#friend-request-body") as HTMLElement;

	mountFriendRequest(root, (path) => {
