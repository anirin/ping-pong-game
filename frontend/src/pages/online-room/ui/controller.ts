import { createRoom, joinRoom } from '../model/online-room-model'

export function mountRoomEntrance(root: HTMLElement, navigate: (path: string) => void) {
	...
	$createBtn.addEventListener('click', async () => {
		...
		const roomName = (root.querySelector('#roomName') as HTMLInputElement).value
