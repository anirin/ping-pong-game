...
async function main() {
  ...
  const defaultHardhatPrivateKeyForAccount1 = "0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d";
  ...
  console.log(`BACKEND_WALLET_PRIVATE_KEY=${defaultHardhatPrivateKeyForAccount1}`);
  console.log("----------------------------------------------------");
